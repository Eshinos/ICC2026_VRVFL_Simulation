...
from UniformSampler import uniformsampler_method
...
def main():
    ...
    parser.add_argument("--frflparameter", type=int, default=20, help="Epsilon in FRFL")
    ...
    uniformsampler_method(accuracy_list, loss_list, args.alpha, args.save_dir_name, args.localsteps , args.verbose, args.rounds)
